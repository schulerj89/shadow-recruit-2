...
- Smoke screenshots: `artifacts/smoke/v0.16.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.16.1/playthrough-report.json` (captured)
- Failure/retry route: `docs/qa/2026-06-20/v0.16.1/failure-retry-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.16.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.16.1/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.16.1/mission-catalog.json` (captured)
- Screenshot coverage: 19/19 expected captures present (12454.5 KB)
...
- Renderer metrics: 72 draw calls, 96803 triangles, 73 geometries, 16 textures, profile=performance, shadows=false, shadowMap=0
...
- PASS enemy/sentry-server: Server sentry; visible=true; grounded=true. pos=(27.03,0,14.08); y=0.02..1.57; h=1.55; xz=1.75x1.75 Sentry GLB is visible above the floor and aligned to its patrol route.
...
- PASS failure-route-screenshots: artifacts/failure-retry/v0.16.1/01-sentry-contact.png, artifacts/failure-retry/v0.16.1/02-retry-loading.png, artifacts/failure-retry/v0.16.1/03-retry-tutorial-reset.png
...
- PASS screenshot/loading-level-one.png: captured (521.7 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (664.3 KB)
- PASS screenshot/focus-lobby-door.png: captured (743.1 KB)
- PASS screenshot/focus-server-door.png: captured (691.3 KB)
- PASS screenshot/gameplay-command-codes.png: captured (639.3 KB)
