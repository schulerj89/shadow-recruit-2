...
- Smoke screenshots: `artifacts/smoke/v0.7.2`
- Browser playthrough: `docs/qa/2026-06-20/v0.7.2/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.7.2/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.7.2/metrics.json`
- Screenshot coverage: 14/14 expected captures present (13514.7 KB)
- Metrics available: yes
- Game frame pacing: 56.2 FPS, 17.8 ms median, 18.1 ms latest, 18.2 ms p95, 240 samples
- Browser baseline: 56.2 FPS, 17.8 ms median, 18.2 ms p95, 240 samples
...
- PASS screenshot/title.png: captured (684.9 KB)
- PASS screenshot/settings.png: captured (538.3 KB)
- PASS screenshot/hero-select.png: captured (652.3 KB)
- PASS screenshot/tutorial-01-insertion.png: captured (1120.3 KB)
