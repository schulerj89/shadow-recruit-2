...
- Smoke screenshots: `artifacts/smoke/v0.9.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.9.0/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.9.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.9.0/metrics.json`
- Screenshot coverage: 14/14 expected captures present (13512.1 KB)
- Metrics available: yes
- Game frame pacing: 56.2 FPS, 17.8 ms median, 18.0 ms latest, 18.2 ms p95, 240 samples
...
- Title composition: heroReadable=true; facingDot=0.99; cameraDistance=7.53; heroYaw=0.57; yawToCamera=0.71
...
- PASS set-dressing/level-set-dressing: Tactical set dressing; visible=true; grounded=true. 15 coordinate-authored non-colliding dressing placements use 3 generated GLB kit assets for cables, wall machinery, racks, consoles, and extraction equipment without blocking the validation route.
...
- PASS screenshot/title.png: captured (750.4 KB)
- PASS screenshot/settings.png: captured (616.5 KB)
- PASS screenshot/hero-select.png: captured (732.4 KB)
- PASS screenshot/tutorial-01-insertion.png: captured (1108.0 KB)
- PASS screenshot/tutorial-02-keycard.png: captured (855.8 KB)
- PASS screenshot/tutorial-03-terminal.png: captured (1097.2 KB)
- PASS screenshot/tutorial-04-sentry.png: captured (1019.5 KB)
- PASS screenshot/tutorial-05-extraction.png: captured (974.5 KB)
- PASS screenshot/gameplay-level-one.png: captured (977.1 KB)
- PASS screenshot/focus-lobby-door.png: captured (1160.9 KB)
- PASS screenshot/focus-server-door.png: captured (1159.7 KB)
- PASS screenshot/gameplay-command-codes.png: captured (987.4 KB)
- PASS screenshot/focus-extraction-door.png: captured (1157.5 KB)
- PASS screenshot/complete.png: captured (915.2 KB)
