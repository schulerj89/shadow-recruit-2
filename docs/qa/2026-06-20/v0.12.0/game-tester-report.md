...
- Smoke screenshots: `artifacts/smoke/v0.12.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.12.0/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.12.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.12.0/metrics.json`
- Screenshot coverage: 15/15 expected captures present (9421.5 KB)
...
- PASS screenshot/settings.png: captured (458.5 KB)
- PASS screenshot/hero-select.png: captured (532.8 KB)
