...
- Smoke screenshots: `artifacts/smoke/v0.15.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.15.1/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.15.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.15.1/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.15.1/mission-catalog.json` (captured)
- Screenshot coverage: 16/16 expected captures present (9967.8 KB)
...
- Game frame pacing: 55.9 FPS, 17.9 ms median, 18.1 ms latest, 18.2 ms p95, 240 samples
...
- Runtime asset audit: 8 pass, 0 review, 0 fail; visibleFallbacks=0; sources=repo-generated-glb, sneak-game-seed
...
- Loading state: 7 steps; latest="starting cinematic tutorial" 100%; captured=loading title hero:18% -> building rotating level preview:62% -> ready:100% -> preloading hero, sentry, objectives:18% -> preloading tactical dressing:42% -> building blacksite threshold:68% -> starting cinematic tutorial:100%
...
- Geometry diagnostics: 51 object bounds; 3 door checks; 3 wall-run checks; levelDensity=pass (14.0%); zones=entry-lobby:pass:12.0%, security-stack:pass:10.0%, server-wing:pass:17.0%, command-extraction:pass:18.0%
...
- PASS enemy/sentry-lobby: Lobby sentry; visible=true; grounded=true. pos=(5.86,0,-24.16); y=0.02..1.57; h=1.55; xz=1.58x1.58 Sentry GLB is visible above the floor and aligned to its patrol route.
- PASS enemy/sentry-server: Server sentry; visible=true; grounded=true. pos=(26.97,0,14.07); y=0.02..1.57; h=1.55; xz=1.75x1.75 Sentry GLB is visible above the floor and aligned to its patrol route.
- PASS enemy/sentry-command: Command sentry; visible=true; grounded=true. pos=(-4.31,0,25); y=0.02..1.57; h=1.55; xz=1.46x1.46 Sentry GLB is visible above the floor and aligned to its patrol route.
...
- PASS screenshot/settings.png: captured (456.9 KB)
- PASS screenshot/hero-select.png: captured (529.1 KB)
- PASS screenshot/loading-level-one.png: captured (521.8 KB)
- PASS screenshot/tutorial-01-insertion.png: captured (705.7 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (657.1 KB)
- PASS screenshot/focus-lobby-door.png: captured (694.8 KB)
- PASS screenshot/focus-server-door.png: captured (668.0 KB)
- PASS screenshot/gameplay-command-codes.png: captured (654.1 KB)
- PASS screenshot/focus-extraction-door.png: captured (688.0 KB)
- PASS screenshot/complete.png: captured (549.5 KB)
