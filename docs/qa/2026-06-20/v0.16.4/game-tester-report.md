...
- Smoke screenshots: `artifacts/smoke/v0.16.4`
- Browser playthrough: `docs/qa/2026-06-20/v0.16.4/playthrough-report.json` (captured)
- Failure/retry route: `docs/qa/2026-06-20/v0.16.4/failure-retry-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.16.4/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.16.4/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.16.4/mission-catalog.json` (captured)
- Screenshot coverage: 19/19 expected captures present (12425.8 KB)
...
- Game frame pacing: 55.9 FPS, 17.9 ms median, 17.7 ms latest, 18.2 ms p95, 240 samples
...
- FPS scene matrix: title=environment-limited (56.2 FPS, 17.8 ms median, 18.2 ms p95, overhead=-0.1 ms/0.1 ms); gameplay=environment-limited (55.9 FPS, 17.9 ms median, 18.2 ms p95, overhead=0.0 ms/0.1 ms); complete=environment-limited (55.9 FPS, 17.9 ms median, 18.1 ms p95, overhead=0.0 ms/0.0 ms); caught=environment-limited (55.9 FPS, 17.9 ms median, 18.2 ms p95, overhead=0.0 ms/0.1 ms)
- Renderer metrics: 63 draw calls, 96695 triangles, 73 geometries, 16 textures, pixelRatio=0.75, profile=performance, shadows=false, shadowMap=0
...
- ENVIRONMENT-LIMITED fps/title: label="Title hero and menu"; phase=title; screenshot=docs/qa/2026-06-20/v0.16.4/fps/fps-title.png; frame=56.2 FPS / 17.8 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=-0.1 ms median/0.1 ms p95; audio=title; renderer=38 calls/98773 tris/7 textures/pixelRatio=0.75. titleHero=facingDot=0.99; screenHeight=44.0%; occupancy=10.0%
- ENVIRONMENT-LIMITED fps/gameplay: label="Active gameplay camera"; phase=playing; screenshot=docs/qa/2026-06-20/v0.16.4/fps/fps-gameplay.png; frame=55.9 FPS / 17.9 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; audio=gameplay; renderer=63 calls/96695 tris/16 textures/pixelRatio=0.75.
- ENVIRONMENT-LIMITED fps/complete: label="Mission complete screen"; phase=complete; screenshot=docs/qa/2026-06-20/v0.16.4/fps/fps-complete.png; frame=55.9 FPS / 17.9 ms median / 18.1 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.0 ms p95; audio=complete; renderer=63 calls/96695 tris/17 textures/pixelRatio=0.75.
- ENVIRONMENT-LIMITED fps/caught: label="Sentry caught failure screen"; phase=caught; screenshot=docs/qa/2026-06-20/v0.16.4/fps/fps-caught.png; frame=55.9 FPS / 17.9 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; audio=gameplay; renderer=97 calls/185649 tris/22 textures/pixelRatio=0.75.
...
- PASS gameplay-camera: active=true; readable=true; cameraDistance=6.23; target=(-24,1.15,-25); camera=(-20.85,3.85,-20.35); screenHeight=29.0%; screenOccupancy=4.0%; screenBounds=x=620.01..819.99, y=376.02..633.56, viewport=1440x900, width=14.0%, height=29.0%, area=4.0%. Gameplay camera keeps the player close enough to read the hero, nearby floor texture, cover, doors, and objectives.
...
- PASS caught-state: enemy=sentry-lobby; pos=(15.477232025990215,-24.95643600216586); radius=2.45; phase=caught; alerts=1; player=(15.477232025990215,-24.95643600216586); sentryAssetLoaded=true; enemyQualityPasses=3; panel="OPERATION FAILED Sentry contact You were too close to a sentry. Reset the mission and use cover timing. Retry Title"; doors=lobby-door:closed:0, server-door:closed:0, extraction-door:closed:0
...
- PASS failure-route-screenshots: artifacts/failure-retry/v0.16.4/01-sentry-contact.png, artifacts/failure-retry/v0.16.4/02-retry-loading.png, artifacts/failure-retry/v0.16.4/03-retry-tutorial-reset.png
...
- PASS screenshot/hero-select.png: captured (529.2 KB)
- PASS screenshot/loading-level-one.png: captured (524.0 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (644.3 KB)
- PASS screenshot/focus-lobby-door.png: captured (743.1 KB)
- PASS screenshot/focus-server-door.png: captured (691.3 KB)
- PASS screenshot/gameplay-command-codes.png: captured (649.9 KB)
- PASS screenshot/focus-extraction-door.png: captured (698.0 KB)
- PASS screenshot/complete.png: captured (575.1 KB)
- PASS screenshot/caught-sentry.png: captured (613.5 KB)
