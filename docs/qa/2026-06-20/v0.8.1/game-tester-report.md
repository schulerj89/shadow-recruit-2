...
- Smoke screenshots: `artifacts/smoke/v0.8.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.8.1/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.8.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.8.1/metrics.json`
- Screenshot coverage: 14/14 expected captures present (13634.5 KB)
...
- Title composition: heroReadable=true; facingDot=0.99; cameraDistance=7.54; heroYaw=0.57; yawToCamera=0.71
...
- PASS screenshot/title.png: captured (749.8 KB)
- PASS screenshot/settings.png: captured (617.8 KB)
- PASS screenshot/hero-select.png: captured (730.5 KB)
...
- PASS screenshot/tutorial-04-sentry.png: captured (1030.6 KB)
...
- PASS screenshot/gameplay-command-codes.png: captured (1014.6 KB)
- PASS screenshot/focus-extraction-door.png: captured (1161.4 KB)
- PASS screenshot/complete.png: captured (924.0 KB)
