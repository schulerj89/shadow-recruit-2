...
- Smoke screenshots: `artifacts/smoke/v0.10.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.10.1/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.10.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.10.1/metrics.json`
- Screenshot coverage: 14/14 expected captures present (9002.1 KB)
...
- Title composition: heroReadable=true; facingDot=0.99; cameraDistance=7.63; heroYaw=0.55; yawToCamera=0.69
...
- PASS screenshot/title.png: captured (624.9 KB)
- PASS screenshot/settings.png: captured (493.0 KB)
- PASS screenshot/hero-select.png: captured (577.0 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (657.7 KB)
...
- PASS screenshot/focus-extraction-door.png: captured (688.5 KB)
