...
- Smoke screenshots: `artifacts/smoke/v0.3.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.3.1/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.3.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.3.1/metrics.json`
...
- P1: Current headed browser baseline measured 55.9 FPS / 17.9 ms median and cannot prove strict 16.7 ms. The game tracks that baseline within tolerance, so rerun on a true 60 Hz visible browser before marking the 60 FPS gate fully proven.
