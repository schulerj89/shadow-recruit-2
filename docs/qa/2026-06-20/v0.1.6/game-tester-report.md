...
- Smoke screenshots: `artifacts/smoke/v0.1.6`
- Committed screenshots: `docs/qa/2026-06-20/v0.1.6/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.1.6/metrics.json`
- Metrics available: yes
- Game frame pacing: 55.6 FPS, 18.0 ms median, 17.1 ms latest, 18.1 ms p95, 240 samples
