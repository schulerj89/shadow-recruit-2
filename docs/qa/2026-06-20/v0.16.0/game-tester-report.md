...
- Smoke screenshots: `artifacts/smoke/v0.16.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.16.0/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.16.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.16.0/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.16.0/mission-catalog.json` (captured)
- Screenshot coverage: 16/16 expected captures present (10294.3 KB)
...
- Game frame pacing: 56.2 FPS, 17.8 ms median, 17.4 ms latest, 18.2 ms p95, 240 samples
...
- PASS screenshot/loading-level-one.png: captured (521.9 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (664.5 KB)
- PASS screenshot/focus-lobby-door.png: captured (743.1 KB)
- PASS screenshot/focus-server-door.png: captured (691.3 KB)
- PASS screenshot/gameplay-command-codes.png: captured (639.1 KB)
