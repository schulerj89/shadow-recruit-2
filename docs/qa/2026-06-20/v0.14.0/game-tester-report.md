...
- Smoke screenshots: `artifacts/smoke/v0.14.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.14.0/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.14.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.14.0/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.14.0/mission-catalog.json` (captured)
- Screenshot coverage: 16/16 expected captures present (9967.2 KB)
...
- Game frame pacing: 55.9 FPS, 17.9 ms median, 17.6 ms latest, 18.1 ms p95, 240 samples
...
- PASS screenshot/settings.png: captured (458.1 KB)
- PASS screenshot/hero-select.png: captured (528.4 KB)
- PASS screenshot/loading-level-one.png: captured (520.4 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (657.2 KB)
- PASS screenshot/focus-lobby-door.png: captured (694.7 KB)
- PASS screenshot/focus-server-door.png: captured (668.0 KB)
- PASS screenshot/gameplay-command-codes.png: captured (654.2 KB)
