...
- Smoke screenshots: `artifacts/smoke/v0.7.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.7.1/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.7.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.7.1/metrics.json`
- Screenshot coverage: 14/14 expected captures present (13504.5 KB)
- Metrics available: yes
- Game frame pacing: 55.9 FPS, 17.9 ms median, 17.8 ms latest, 18.1 ms p95, 240 samples
...
- PASS screenshot/title.png: captured (684.4 KB)
- PASS screenshot/settings.png: captured (538.7 KB)
- PASS screenshot/hero-select.png: captured (650.8 KB)
- PASS screenshot/tutorial-01-insertion.png: captured (1118.2 KB)
- PASS screenshot/tutorial-02-keycard.png: captured (890.6 KB)
- PASS screenshot/tutorial-03-terminal.png: captured (1117.0 KB)
- PASS screenshot/tutorial-04-sentry.png: captured (1035.9 KB)
...
- PASS screenshot/gameplay-command-codes.png: captured (1076.7 KB)
