...
- Smoke screenshots: `artifacts/smoke/v0.10.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.10.0/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.10.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.10.0/metrics.json`
- Screenshot coverage: 14/14 expected captures present (9000.6 KB)
- Metrics available: yes
- Game frame pacing: 56.2 FPS, 17.8 ms median, 17.5 ms latest, 18.2 ms p95, 240 samples
...
- PASS screenshot/title.png: captured (624.7 KB)
- PASS screenshot/settings.png: captured (492.8 KB)
- PASS screenshot/hero-select.png: captured (576.4 KB)
