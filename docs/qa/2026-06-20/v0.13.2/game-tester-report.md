...
- Smoke screenshots: `artifacts/smoke/v0.13.2`
- Browser playthrough: `docs/qa/2026-06-20/v0.13.2/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.13.2/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.13.2/metrics.json`
- Screenshot coverage: 16/16 expected captures present (9973.9 KB)
- Metrics available: yes
- Game frame pacing: 55.9 FPS, 17.9 ms median, 17.3 ms latest, 18.2 ms p95, 240 samples
...
- PASS enemy/sentry-lobby: Lobby sentry; visible=true; grounded=true. pos=(5.84,0,-24.15); y=0.02..1.57; h=1.55; xz=1.58x1.58 Sentry GLB is visible above the floor and aligned to its patrol route.
- PASS enemy/sentry-server: Server sentry; visible=true; grounded=true. pos=(26.99,0,14.07); y=0.02..1.57; h=1.55; xz=1.75x1.75 Sentry GLB is visible above the floor and aligned to its patrol route.
- PASS enemy/sentry-command: Command sentry; visible=true; grounded=true. pos=(-4.29,0,25); y=0.02..1.57; h=1.55; xz=1.46x1.46 Sentry GLB is visible above the floor and aligned to its patrol route.
...
- PASS screenshot/title.png: captured (557.3 KB)
- PASS screenshot/title-orbit-preview.png: captured (572.3 KB)
- PASS screenshot/settings.png: captured (456.6 KB)
- PASS screenshot/hero-select.png: captured (531.5 KB)
- PASS screenshot/loading-level-one.png: captured (525.8 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (657.3 KB)
...
- PASS screenshot/complete.png: captured (549.4 KB)
