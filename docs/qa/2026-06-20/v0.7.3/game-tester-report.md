...
- Smoke screenshots: `artifacts/smoke/v0.7.3`
- Browser playthrough: `docs/qa/2026-06-20/v0.7.3/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.7.3/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.7.3/metrics.json`
- Screenshot coverage: 14/14 expected captures present (13514.1 KB)
...
- Completion stats: active=true; objectives=3/3; alerts=0; cue=triumphant; elapsed=13s
...
- PASS screenshot/title.png: captured (685.6 KB)
- PASS screenshot/settings.png: captured (538.4 KB)
- PASS screenshot/hero-select.png: captured (651.6 KB)
- PASS screenshot/tutorial-01-insertion.png: captured (1120.1 KB)
- PASS screenshot/tutorial-02-keycard.png: captured (892.9 KB)
- PASS screenshot/tutorial-03-terminal.png: captured (1119.2 KB)
- PASS screenshot/tutorial-04-sentry.png: captured (1037.5 KB)
- PASS screenshot/tutorial-05-extraction.png: captured (991.4 KB)
- PASS screenshot/gameplay-level-one.png: captured (1010.8 KB)
