...
- Smoke screenshots: `artifacts/smoke/v0.22.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.22.0/playthrough-report.json` (captured)
- Browser playthrough matrix: `docs/qa/2026-06-20/v0.22.0/playthrough-matrix.json` (2/2 mission browser playthroughs passed)
- Failure/retry route: `docs/qa/2026-06-20/v0.22.0/failure-retry-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.22.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.22.0/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.22.0/mission-catalog.json` (captured)
- Mission readiness matrix: `docs/qa/2026-06-20/v0.22.0/mission-readiness.json` (2/2 pass; 0 review; 0 fail)
- Operative trait evidence: `docs/qa/2026-06-20/v0.22.0/operative-traits.json` (captured)
- Gameplay view density evidence: `docs/qa/2026-06-20/v0.22.0/gameplay-view-density.json` (captured)
- Screenshot coverage: 19/19 expected captures present (12618.3 KB)
...
- Game frame pacing: 55.9 FPS, 17.9 ms median, 17.2 ms latest, 18.2 ms p95, 240 samples
- Browser baseline: 55.9 FPS, 17.9 ms median, 18.2 ms p95, 240 samples
- FPS gate: environment-limited; profile=performance; strictTarget=false; browserCanProve60=false; tracksBaseline=true; overhead=0.0 ms median/0.0 ms p95; headroom=-0.8 ms game/-0.8 ms browser
- FPS scene matrix: title=environment-limited (56.2 FPS, 17.8 ms median, 18.2 ms p95, overhead=-0.1 ms/0.0 ms); gameplay=environment-limited (55.9 FPS, 17.9 ms median, 18.2 ms p95, overhead=0.0 ms/0.0 ms); complete=environment-limited (55.9 FPS, 17.9 ms median, 18.2 ms p95, overhead=0.0 ms/0.0 ms); caught=environment-limited (56.2 FPS, 17.8 ms median, 18.1 ms p95, overhead=-0.1 ms/-0.1 ms)
...
- Title composition: heroReadable=true; identityReadable=true; levelPreview=true; facingDot=0.99; cameraDistance=6.14; screenHeight=44.0%; screenOccupancy=11.0%; screenBounds=x=550.97..921.64, y=289.78..688.63, viewport=1440x900, width=26.0%, height=44.0%, area=11.0%; anchors=head:readable, visor:readable, chest:readable, feet:readable; orbitAngle=0.3; orbitRadius=5.31; heroYaw=1.13; yawToCamera=1.27
...
- BASELINE browser: 55.9 FPS; median=17.9 ms; p95=18.2 ms; samples=240
- ENVIRONMENT-LIMITED fps/title: label="Title hero and menu"; phase=title; screenshot=docs/qa/2026-06-20/v0.22.0/fps/fps-title.png; frame=56.2 FPS / 17.8 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=-0.1 ms median/0.0 ms p95; audio=title; renderer=41 calls/98809 tris/7 textures/pixelRatio=0.75; budget=pass; headroom=719 calls/321191 tris/27 tex. titleHero=facingDot=0.99; screenHeight=44.0%; occupancy=10.0%
- ENVIRONMENT-LIMITED fps/gameplay: label="Active gameplay camera"; phase=playing; screenshot=docs/qa/2026-06-20/v0.22.0/fps/fps-gameplay.png; frame=55.9 FPS / 17.9 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.0 ms p95; audio=gameplay; renderer=676 calls/296698 tris/21 textures/pixelRatio=0.75; budget=pass; headroom=84 calls/123302 tris/13 tex.
- ENVIRONMENT-LIMITED fps/complete: label="Mission complete screen"; phase=complete; screenshot=docs/qa/2026-06-20/v0.22.0/fps/fps-complete.png; frame=55.9 FPS / 17.9 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.0 ms p95; audio=complete; renderer=674 calls/208128 tris/22 textures/pixelRatio=0.75; budget=pass; headroom=86 calls/211872 tris/12 tex.
- ENVIRONMENT-LIMITED fps/caught: label="Sentry caught failure screen"; phase=caught; screenshot=docs/qa/2026-06-20/v0.22.0/fps/fps-caught.png; frame=56.2 FPS / 17.8 ms median / 18.1 ms p95; strict=false; tracksBaseline=true; overhead=-0.1 ms median/-0.1 ms p95; audio=gameplay; renderer=693 calls/374837 tris/26 textures/pixelRatio=0.75; budget=pass; headroom=67 calls/45163 tris/8 tex.
...
- PASS render-budget/title: pass; profile=performance; calls=41/760; triangles=98809/420000; geometries=42/130; textures=7/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.22.0/fps/fps-title.png; headroom=719 calls, 321191 triangles, 88 geometries, 27 textures, 0 pixel ratio.
- PASS render-budget/gameplay: pass; profile=performance; calls=676/760; triangles=296698/420000; geometries=102/130; textures=21/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.22.0/fps/fps-gameplay.png; headroom=84 calls, 123302 triangles, 28 geometries, 13 textures, 0 pixel ratio.
- PASS render-budget/complete: pass; profile=performance; calls=674/760; triangles=208128/420000; geometries=101/130; textures=22/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.22.0/fps/fps-complete.png; headroom=86 calls, 211872 triangles, 29 geometries, 12 textures, 0 pixel ratio.
- PASS render-budget/caught: pass; profile=performance; calls=693/760; triangles=374837/420000; geometries=113/130; textures=26/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.22.0/fps/fps-caught.png; headroom=67 calls, 45163 triangles, 17 geometries, 8 textures, 0 pixel ratio.
...
- PASS title-anchor/head: Head silhouette; source=bounds-estimate; world=(2.6,1.79,-18); screen=(720,349.33) visible=true; uiOccluded=false. Head silhouette projects into the title screenshot without UI occlusion.
- PASS title-anchor/visor: Face/visor read; source=bounds-estimate; world=(2.6,1.64,-18); screen=(720,373.51) visible=true; uiOccluded=false. Face/visor read projects into the title screenshot without UI occlusion.
- PASS title-anchor/chest: Chest/gear read; source=bounds-estimate; world=(2.6,1.17,-18); screen=(720,443.28) visible=true; uiOccluded=false. Chest/gear read projects into the title screenshot without UI occlusion.
- PASS title-anchor/feet: Foot grounding; source=bounds-estimate; world=(2.6,0.11,-18); screen=(720,586.43) visible=true; uiOccluded=false. Foot grounding projects into the title screenshot without UI occlusion.
...
- Mission readiness build=v0.22.0; 2/2 pass; 0 review; 0 fail; densityTargets=level 18.0%, zone 20.0%; wallRunEpsilon=0.08m
...
- Matrix build=v0.22.0; generatedAt=2026-06-20T11:26:36.787Z; 2/2 mission browser playthroughs passed
- PASS playthrough/blacksite-threshold: status=pass; source=artifacts\playthrough\v0.22.0\playthrough-report.json; committed=docs/qa/2026-06-20/v0.22.0/playthroughs/blacksite-threshold/playthrough-report.json; screenshots=6; missingScreenshots=0; catalogKnown=true
- PASS playthrough/relay-vault: status=pass; source=artifacts\playthrough\v0.22.0\relay-vault\playthrough-report.json; committed=docs/qa/2026-06-20/v0.22.0/playthroughs/relay-vault/playthrough-report.json; screenshots=6; missingScreenshots=0; catalogKnown=true
...
- PASS enemy/sentry-command: Command sentry; visible=true; grounded=true. pos=(-4.23,0,25); y=0.02..1.57; h=1.55; xz=1.46x1.46 Sentry GLB is visible above the floor and aligned to its patrol route.
...
- PASS failure-route-screenshots: artifacts/failure-retry/v0.22.0/01-sentry-contact.png, artifacts/failure-retry/v0.22.0/02-retry-loading.png, artifacts/failure-retry/v0.22.0/03-retry-tutorial-reset.png

## Screenshot Coverage

- PASS screenshot/title.png: captured (558.2 KB)
- PASS screenshot/title-orbit-preview.png: captured (572.6 KB)
- PASS screenshot/settings.png: captured (456.2 KB)
- PASS screenshot/hero-select.png: captured (530.7 KB)
- PASS screenshot/loading-level-one.png: captured (437.1 KB)
- PASS screenshot/tutorial-01-insertion.png: captured (781.9 KB)
- PASS screenshot/tutorial-02-keycard.png: captured (685.2 KB)
- PASS screenshot/tutorial-03-terminal.png: captured (794.5 KB)
- PASS screenshot/tutorial-04-sentry.png: captured (808.1 KB)
- PASS screenshot/tutorial-05-extraction.png: captured (722.0 KB)
- PASS screenshot/gameplay-level-one.png: captured (660.1 KB)
- PASS screenshot/focus-lobby-door.png: captured (765.5 KB)
- PASS screenshot/focus-server-door.png: captured (692.4 KB)
- PASS screenshot/gameplay-command-codes.png: captured (622.6 KB)
- PASS screenshot/focus-extraction-door.png: captured (760.1 KB)
- PASS screenshot/complete.png: captured (586.1 KB)
- PASS screenshot/caught-sentry.png: captured (619.6 KB)
- PASS screenshot/retry-loading.png: captured (782.7 KB)
- PASS screenshot/retry-tutorial-reset.png: captured (782.7 KB)
...
- Performance: 4 scene samples match the 55.9 FPS browser baseline with 0.0 ms median / 0.0 ms p95 overhead, but this environment cannot prove strict 16.7 ms frame cadence.
...
- P1: Current headed browser baseline measured 55.9 FPS / 17.9 ms median and cannot prove strict 16.7 ms on the performance profile. The game tracks that baseline within the calibrated overhead budget across 4 scene sample(s): title=environment-limited, gameplay=environment-limited, complete=environment-limited, caught=environment-limited (0.0 ms median / 0.0 ms p95), so rerun on a true 60 Hz visible browser before marking the 60 FPS gate fully proven.
