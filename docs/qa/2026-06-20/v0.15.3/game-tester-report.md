...
- Smoke screenshots: `artifacts/smoke/v0.15.3`
- Browser playthrough: `docs/qa/2026-06-20/v0.15.3/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.15.3/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.15.3/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.15.3/mission-catalog.json` (captured)
- Screenshot coverage: 16/16 expected captures present (10297.7 KB)
...
- Game frame pacing: 56.2 FPS, 17.8 ms median, 18.1 ms latest, 18.1 ms p95, 240 samples
...
- PASS screenshot/hero-select.png: captured (529.0 KB)
- PASS screenshot/loading-level-one.png: captured (523.3 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (664.7 KB)
