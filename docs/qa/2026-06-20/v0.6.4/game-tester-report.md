...
- Smoke screenshots: `artifacts/smoke/v0.6.4`
- Browser playthrough: `docs/qa/2026-06-20/v0.6.4/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.6.4/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.6.4/metrics.json`
- Screenshot coverage: 14/14 expected captures present (5366.7 KB)
- Metrics available: yes
- Game frame pacing: 56.2 FPS, 17.8 ms median, 17.2 ms latest, 18.1 ms p95, 240 samples
...
- PASS screenshot/title.png: captured (448.6 KB)
- PASS screenshot/settings.png: captured (266.8 KB)
- PASS screenshot/hero-select.png: captured (327.9 KB)
- PASS screenshot/tutorial-01-insertion.png: captured (465.3 KB)
