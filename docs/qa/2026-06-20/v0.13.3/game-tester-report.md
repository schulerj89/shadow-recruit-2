...
- Smoke screenshots: `artifacts/smoke/v0.13.3`
- Browser playthrough: `docs/qa/2026-06-20/v0.13.3/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.13.3/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.13.3/metrics.json`
- Screenshot coverage: 16/16 expected captures present (9974.6 KB)
- Metrics available: yes
- Game frame pacing: 55.9 FPS, 17.9 ms median, 17.8 ms latest, 18.2 ms p95, 240 samples
...
- PASS screenshot/settings.png: captured (457.5 KB)
- PASS screenshot/hero-select.png: captured (531.4 KB)
- PASS screenshot/loading-level-one.png: captured (525.6 KB)
...
- PASS screenshot/tutorial-04-sentry.png: captured (690.4 KB)
...
- P1: Current headed browser baseline measured 56.2 FPS / 17.8 ms median and cannot prove strict 16.7 ms on the performance profile. The game tracks that baseline within tolerance, so rerun on a true 60 Hz visible browser before marking the 60 FPS gate fully proven.
