...
- Smoke screenshots: `artifacts/smoke/v0.13.4`
- Browser playthrough: `docs/qa/2026-06-20/v0.13.4/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.13.4/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.13.4/metrics.json`
- Screenshot coverage: 16/16 expected captures present (9975.4 KB)
...
- PASS screenshot/hero-select.png: captured (531.9 KB)
- PASS screenshot/loading-level-one.png: captured (526.6 KB)
