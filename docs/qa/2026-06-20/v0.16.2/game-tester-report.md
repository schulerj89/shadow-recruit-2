...
- Smoke screenshots: `artifacts/smoke/v0.16.2`
- Browser playthrough: `docs/qa/2026-06-20/v0.16.2/playthrough-report.json` (captured)
- Failure/retry route: `docs/qa/2026-06-20/v0.16.2/failure-retry-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.16.2/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.16.2/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.16.2/mission-catalog.json` (captured)
- Screenshot coverage: 19/19 expected captures present (12455.4 KB)
...
- Game frame pacing: 56.2 FPS, 17.8 ms median, 17.8 ms latest, 18.2 ms p95, 240 samples
- Browser baseline: 56.2 FPS, 17.8 ms median, 18.1 ms p95, 240 samples
- FPS gate: environment-limited; profile=performance; strictTarget=false; browserCanProve60=false; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; headroom=-0.7 ms game/-0.7 ms browser
...
- PASS enemy/sentry-command: Command sentry; visible=true; grounded=true. pos=(-4.25,0,25); y=0.02..1.57; h=1.55; xz=1.46x1.46 Sentry GLB is visible above the floor and aligned to its patrol route.
...
- PASS failure-route-screenshots: artifacts/failure-retry/v0.16.2/01-sentry-contact.png, artifacts/failure-retry/v0.16.2/02-retry-loading.png, artifacts/failure-retry/v0.16.2/03-retry-tutorial-reset.png
...
- PASS screenshot/hero-select.png: captured (528.8 KB)
- PASS screenshot/loading-level-one.png: captured (522.4 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (664.0 KB)
- PASS screenshot/focus-lobby-door.png: captured (743.1 KB)
- PASS screenshot/focus-server-door.png: captured (691.3 KB)
- PASS screenshot/gameplay-command-codes.png: captured (639.2 KB)
...
- Performance: game pacing matches the 56.2 FPS browser baseline with 0.0 ms median / 0.1 ms p95 overhead, but this environment cannot prove strict 16.7 ms frame cadence.

## Required Fixes

- P0: None recorded by generated report.
- P1: Current headed browser baseline measured 56.2 FPS / 17.8 ms median and cannot prove strict 16.7 ms on the performance profile. The game tracks that baseline within the calibrated overhead budget (0.0 ms median / 0.1 ms p95), so rerun on a true 60 Hz visible browser before marking the 60 FPS gate fully proven.
