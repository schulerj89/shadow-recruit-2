...
- Smoke screenshots: `artifacts/smoke/v0.24.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.24.0/playthrough-report.json` (captured)
- Browser playthrough matrix: `docs/qa/2026-06-20/v0.24.0/playthrough-matrix.json` (2/2 mission browser playthroughs passed)
- Failure/retry route: `docs/qa/2026-06-20/v0.24.0/failure-retry-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.24.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.24.0/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.24.0/mission-catalog.json` (captured)
- Mission readiness matrix: `docs/qa/2026-06-20/v0.24.0/mission-readiness.json` (2/2 pass; 0 review; 0 fail)
- Operative trait evidence: `docs/qa/2026-06-20/v0.24.0/operative-traits.json` (captured)
- Gameplay view density evidence: `docs/qa/2026-06-20/v0.24.0/gameplay-view-density.json` (captured)
- Mission guidance evidence: `docs/qa/2026-06-20/v0.24.0/mission-guidance.json` (captured)
- Screenshot coverage: 19/19 expected captures present (12516.7 KB)
...
- Game frame pacing: 55.9 FPS, 17.9 ms median, 18.0 ms latest, 18.1 ms p95, 240 samples
...
- FPS scene matrix: title=environment-limited (55.9 FPS, 17.9 ms median, 18.2 ms p95, overhead=0.0 ms/0.1 ms); gameplay=environment-limited (55.9 FPS, 17.9 ms median, 18.1 ms p95, overhead=0.0 ms/0.0 ms); complete=environment-limited (56.2 FPS, 17.8 ms median, 18.1 ms p95, overhead=-0.1 ms/0.0 ms); caught=environment-limited (55.9 FPS, 17.9 ms median, 18.1 ms p95, overhead=0.0 ms/0.0 ms)
...
- ENVIRONMENT-LIMITED fps/title: label="Title hero and menu"; phase=title; screenshot=docs/qa/2026-06-20/v0.24.0/fps/fps-title.png; frame=55.9 FPS / 17.9 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; audio=title; renderer=41 calls/98809 tris/7 textures/pixelRatio=0.75; budget=pass; headroom=719 calls/321191 tris/27 tex. titleHero=facingDot=0.99; screenHeight=44.0%; occupancy=10.0%
- ENVIRONMENT-LIMITED fps/gameplay: label="Active gameplay camera"; phase=playing; screenshot=docs/qa/2026-06-20/v0.24.0/fps/fps-gameplay.png; frame=55.9 FPS / 17.9 ms median / 18.1 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.0 ms p95; audio=gameplay; renderer=676 calls/296698 tris/21 textures/pixelRatio=0.75; budget=pass; headroom=84 calls/123302 tris/13 tex.
- ENVIRONMENT-LIMITED fps/complete: label="Mission complete screen"; phase=complete; screenshot=docs/qa/2026-06-20/v0.24.0/fps/fps-complete.png; frame=56.2 FPS / 17.8 ms median / 18.1 ms p95; strict=false; tracksBaseline=true; overhead=-0.1 ms median/0.0 ms p95; audio=complete; renderer=674 calls/208128 tris/22 textures/pixelRatio=0.75; budget=pass; headroom=86 calls/211872 tris/12 tex.
- ENVIRONMENT-LIMITED fps/caught: label="Sentry caught failure screen"; phase=caught; screenshot=docs/qa/2026-06-20/v0.24.0/fps/fps-caught.png; frame=55.9 FPS / 17.9 ms median / 18.1 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.0 ms p95; audio=gameplay; renderer=693 calls/374837 tris/26 textures/pixelRatio=0.75; budget=pass; headroom=67 calls/45163 tris/8 tex.
...
- PASS render-budget/title: pass; profile=performance; calls=41/760; triangles=98809/420000; geometries=42/130; textures=7/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.24.0/fps/fps-title.png; headroom=719 calls, 321191 triangles, 88 geometries, 27 textures, 0 pixel ratio.
- PASS render-budget/gameplay: pass; profile=performance; calls=676/760; triangles=296698/420000; geometries=102/130; textures=21/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.24.0/fps/fps-gameplay.png; headroom=84 calls, 123302 triangles, 28 geometries, 13 textures, 0 pixel ratio.
- PASS render-budget/complete: pass; profile=performance; calls=674/760; triangles=208128/420000; geometries=101/130; textures=22/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.24.0/fps/fps-complete.png; headroom=86 calls, 211872 triangles, 29 geometries, 12 textures, 0 pixel ratio.
- PASS render-budget/caught: pass; profile=performance; calls=693/760; triangles=374837/420000; geometries=113/130; textures=26/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.24.0/fps/fps-caught.png; headroom=67 calls, 45163 triangles, 17 geometries, 8 textures, 0 pixel ratio.
...
- Mission readiness build=v0.24.0; 2/2 pass; 0 review; 0 fail; densityTargets=level 18.0%, zone 20.0%; wallRunEpsilon=0.08m
...
- Matrix build=v0.24.0; generatedAt=2026-06-20T12:15:22.982Z; 2/2 mission browser playthroughs passed
- PASS playthrough/blacksite-threshold: status=pass; source=artifacts\playthrough\v0.24.0\playthrough-report.json; committed=docs/qa/2026-06-20/v0.24.0/playthroughs/blacksite-threshold/playthrough-report.json; screenshots=6; missingScreenshots=0; catalogKnown=true
- PASS playthrough/relay-vault: status=pass; source=artifacts\playthrough\v0.24.0\relay-vault\playthrough-report.json; committed=docs/qa/2026-06-20/v0.24.0/playthroughs/relay-vault/playthrough-report.json; screenshots=6; missingScreenshots=0; catalogKnown=true
...
- PASS enemy/sentry-lobby: Lobby sentry; visible=true; grounded=true. pos=(5.85,0,-24.15); y=0.02..1.57; h=1.55; xz=1.58x1.58 Sentry GLB is visible above the floor and aligned to its patrol route.
- PASS enemy/sentry-server: Server sentry; visible=true; grounded=true. pos=(26.98,0,14.07); y=0.02..1.57; h=1.55; xz=1.75x1.75 Sentry GLB is visible above the floor and aligned to its patrol route.
- PASS enemy/sentry-command: Command sentry; visible=true; grounded=true. pos=(-4.3,0,25); y=0.02..1.57; h=1.55; xz=1.46x1.46 Sentry GLB is visible above the floor and aligned to its patrol route.
...
- PASS failure-route-screenshots: artifacts/failure-retry/v0.24.0/01-sentry-contact.png, artifacts/failure-retry/v0.24.0/02-retry-loading.png, artifacts/failure-retry/v0.24.0/03-retry-tutorial-reset.png

## Screenshot Coverage

- PASS screenshot/title.png: captured (558.1 KB)
- PASS screenshot/title-orbit-preview.png: captured (572.6 KB)
- PASS screenshot/settings.png: captured (456.3 KB)
- PASS screenshot/hero-select.png: captured (525.9 KB)
- PASS screenshot/loading-level-one.png: captured (437.8 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (648.7 KB)
...
- PASS screenshot/focus-extraction-door.png: captured (733.3 KB)
- PASS screenshot/complete.png: captured (586.0 KB)
