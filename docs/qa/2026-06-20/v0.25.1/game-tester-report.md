...
- Smoke screenshots: `artifacts/smoke/v0.25.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.25.1/playthrough-report.json` (captured)
- Browser playthrough matrix: `docs/qa/2026-06-20/v0.25.1/playthrough-matrix.json` (2/2 mission browser playthroughs passed)
- Failure/retry route: `docs/qa/2026-06-20/v0.25.1/failure-retry-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.25.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.25.1/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.25.1/mission-catalog.json` (captured)
- Mission readiness matrix: `docs/qa/2026-06-20/v0.25.1/mission-readiness.json` (2/2 pass; 0 review; 0 fail)
- Operative trait evidence: `docs/qa/2026-06-20/v0.25.1/operative-traits.json` (captured)
- Gameplay view density evidence: `docs/qa/2026-06-20/v0.25.1/gameplay-view-density.json` (captured)
- Mission guidance evidence: `docs/qa/2026-06-20/v0.25.1/mission-guidance.json` (captured)
- Screenshot coverage: 18/18 expected captures present (12234.6 KB)
...
- Game frame pacing: 59.9 FPS, 16.7 ms median, 16.6 ms latest, 16.8 ms p95, 240 samples
- Browser baseline: 59.9 FPS, 16.7 ms median, 16.8 ms p95, 240 samples
- FPS gate: pass; profile=performance; strictTarget=true; browserCanProve60=true; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; headroom=0.4 ms game/0.4 ms browser
- FPS scene matrix: title=pass (59.9 FPS, 16.7 ms median, 16.9 ms p95, overhead=0.0 ms/0.1 ms); gameplay=pass (59.9 FPS, 16.7 ms median, 16.8 ms p95, overhead=0.0 ms/0.0 ms); complete=pass (59.9 FPS, 16.7 ms median, 16.8 ms p95, overhead=0.0 ms/0.0 ms); caught=pass (59.9 FPS, 16.7 ms median, 16.9 ms p95, overhead=0.0 ms/0.1 ms)
...
- Completion stats: active=true; objectives=3/3; alerts=0; cue=triumphant; elapsed=16s
...
- BASELINE browser: 59.9 FPS; median=16.7 ms; p95=16.8 ms; samples=240
- PASS fps/title: label="Title hero and menu"; phase=title; screenshot=docs/qa/2026-06-20/v0.25.1/fps/fps-title.png; frame=59.9 FPS / 16.7 ms median / 16.9 ms p95; strict=true; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; audio=title; renderer=13 calls/96527 tris/7 textures/pixelRatio=0.75; budget=pass; headroom=747 calls/323473 tris/27 tex. titleHero=facingDot=0.99; screenHeight=44.0%; occupancy=10.0%
- PASS fps/gameplay: label="Active gameplay camera"; phase=playing; screenshot=docs/qa/2026-06-20/v0.25.1/fps/fps-gameplay.png; frame=59.9 FPS / 16.7 ms median / 16.8 ms p95; strict=true; tracksBaseline=true; overhead=0.0 ms median/0.0 ms p95; audio=gameplay; renderer=676 calls/296698 tris/21 textures/pixelRatio=0.75; budget=pass; headroom=84 calls/123302 tris/13 tex.
- PASS fps/complete: label="Mission complete screen"; phase=complete; screenshot=docs/qa/2026-06-20/v0.25.1/fps/fps-complete.png; frame=59.9 FPS / 16.7 ms median / 16.8 ms p95; strict=true; tracksBaseline=true; overhead=0.0 ms median/0.0 ms p95; audio=complete; renderer=674 calls/208128 tris/22 textures/pixelRatio=0.75; budget=pass; headroom=86 calls/211872 tris/12 tex.
- PASS fps/caught: label="Sentry caught failure screen"; phase=caught; screenshot=docs/qa/2026-06-20/v0.25.1/fps/fps-caught.png; frame=59.9 FPS / 16.7 ms median / 16.9 ms p95; strict=true; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; audio=gameplay; renderer=693 calls/374837 tris/26 textures/pixelRatio=0.75; budget=pass; headroom=67 calls/45163 tris/8 tex.
...
- PASS render-budget/title: pass; profile=performance; calls=13/760; triangles=96527/420000; geometries=11/130; textures=7/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.25.1/fps/fps-title.png; headroom=747 calls, 323473 triangles, 119 geometries, 27 textures, 0 pixel ratio.
- PASS render-budget/gameplay: pass; profile=performance; calls=676/760; triangles=296698/420000; geometries=102/130; textures=21/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.25.1/fps/fps-gameplay.png; headroom=84 calls, 123302 triangles, 28 geometries, 13 textures, 0 pixel ratio.
- PASS render-budget/complete: pass; profile=performance; calls=674/760; triangles=208128/420000; geometries=101/130; textures=22/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.25.1/fps/fps-complete.png; headroom=86 calls, 211872 triangles, 29 geometries, 12 textures, 0 pixel ratio.
- PASS render-budget/caught: pass; profile=performance; calls=693/760; triangles=374837/420000; geometries=113/130; textures=26/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.25.1/fps/fps-caught.png; headroom=67 calls, 45163 triangles, 17 geometries, 8 textures, 0 pixel ratio.
...
- Mission readiness build=v0.25.1; 2/2 pass; 0 review; 0 fail; densityTargets=level 18.0%, zone 20.0%; wallRunEpsilon=0.08m
...
- Matrix build=v0.25.1; generatedAt=2026-06-20T14:47:06.195Z; 2/2 mission browser playthroughs passed
- PASS playthrough/blacksite-threshold: status=pass; source=artifacts\playthrough\v0.25.1\playthrough-report.json; committed=docs/qa/2026-06-20/v0.25.1/playthroughs/blacksite-threshold/playthrough-report.json; screenshots=6; missingScreenshots=0; catalogKnown=true
- PASS playthrough/relay-vault: status=pass; source=artifacts\playthrough\v0.25.1\relay-vault\playthrough-report.json; committed=docs/qa/2026-06-20/v0.25.1/playthroughs/relay-vault/playthrough-report.json; screenshots=6; missingScreenshots=0; catalogKnown=true
...
- PASS enemy/sentry-lobby: Lobby sentry; visible=true; grounded=true. pos=(5.9,0,-24.16); y=0.02..1.57; h=1.55; xz=1.58x1.58 Sentry GLB is visible above the floor and aligned to its patrol route.
- PASS enemy/sentry-server: Server sentry; visible=true; grounded=true. pos=(26.94,0,14.06); y=0.02..1.57; h=1.55; xz=1.75x1.75 Sentry GLB is visible above the floor and aligned to its patrol route.
- PASS enemy/sentry-command: Command sentry; visible=true; grounded=true. pos=(-4.35,0,25); y=0.02..1.57; h=1.55; xz=1.46x1.46 Sentry GLB is visible above the floor and aligned to its patrol route.
...
- PASS failure-route-screenshots: artifacts/failure-retry/v0.25.1/01-sentry-contact.png, artifacts/failure-retry/v0.25.1/02-retry-loading.png, artifacts/failure-retry/v0.25.1/03-retry-tutorial-reset.png

## Screenshot Coverage

- PASS screenshot/title.png: captured (665.9 KB)
- PASS screenshot/settings.png: captured (504.1 KB)
- PASS screenshot/hero-select.png: captured (583.9 KB)
- PASS screenshot/loading-level-one.png: captured (515.0 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (648.4 KB)
...
- Performance: 4 scene samples passed the configured 60 FPS gate.
...
- P1: None from generated FPS metrics.
