...
- Smoke screenshots: `artifacts/smoke/v0.12.4`
- Browser playthrough: `docs/qa/2026-06-20/v0.12.4/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.12.4/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.12.4/metrics.json`
- Screenshot coverage: 16/16 expected captures present (9944.9 KB)
...
- PASS screenshot/title.png: captured (554.3 KB)
- PASS screenshot/title-orbit-preview.png: captured (569.1 KB)
- PASS screenshot/settings.png: captured (457.2 KB)
- PASS screenshot/hero-select.png: captured (531.9 KB)
- PASS screenshot/loading-level-one.png: captured (525.9 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (657.4 KB)
