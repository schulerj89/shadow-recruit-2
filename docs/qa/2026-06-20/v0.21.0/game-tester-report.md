...
- Smoke screenshots: `artifacts/smoke/v0.21.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.21.0/playthrough-report.json` (captured)
- Browser playthrough matrix: `docs/qa/2026-06-20/v0.21.0/playthrough-matrix.json` (2/2 mission browser playthroughs passed)
- Failure/retry route: `docs/qa/2026-06-20/v0.21.0/failure-retry-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.21.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.21.0/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.21.0/mission-catalog.json` (captured)
- Operative trait evidence: `docs/qa/2026-06-20/v0.21.0/operative-traits.json` (captured)
- Gameplay view density evidence: `docs/qa/2026-06-20/v0.21.0/gameplay-view-density.json` (captured)
- Screenshot coverage: 19/19 expected captures present (12617.7 KB)
...
- FPS scene matrix: title=environment-limited (55.9 FPS, 17.9 ms median, 18.2 ms p95, overhead=0.0 ms/0.1 ms); gameplay=environment-limited (55.9 FPS, 17.9 ms median, 18.2 ms p95, overhead=0.0 ms/0.1 ms); complete=environment-limited (55.9 FPS, 17.9 ms median, 18.2 ms p95, overhead=0.0 ms/0.1 ms); caught=environment-limited (55.9 FPS, 17.9 ms median, 18.1 ms p95, overhead=0.0 ms/0.0 ms)
...
- ENVIRONMENT-LIMITED fps/title: label="Title hero and menu"; phase=title; screenshot=docs/qa/2026-06-20/v0.21.0/fps/fps-title.png; frame=55.9 FPS / 17.9 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; audio=title; renderer=41 calls/98809 tris/7 textures/pixelRatio=0.75; budget=pass; headroom=719 calls/321191 tris/27 tex. titleHero=facingDot=0.99; screenHeight=44.0%; occupancy=10.0%
- ENVIRONMENT-LIMITED fps/gameplay: label="Active gameplay camera"; phase=playing; screenshot=docs/qa/2026-06-20/v0.21.0/fps/fps-gameplay.png; frame=55.9 FPS / 17.9 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; audio=gameplay; renderer=676 calls/296698 tris/21 textures/pixelRatio=0.75; budget=pass; headroom=84 calls/123302 tris/13 tex.
- ENVIRONMENT-LIMITED fps/complete: label="Mission complete screen"; phase=complete; screenshot=docs/qa/2026-06-20/v0.21.0/fps/fps-complete.png; frame=55.9 FPS / 17.9 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.1 ms p95; audio=complete; renderer=674 calls/208128 tris/22 textures/pixelRatio=0.75; budget=pass; headroom=86 calls/211872 tris/12 tex.
- ENVIRONMENT-LIMITED fps/caught: label="Sentry caught failure screen"; phase=caught; screenshot=docs/qa/2026-06-20/v0.21.0/fps/fps-caught.png; frame=55.9 FPS / 17.9 ms median / 18.1 ms p95; strict=false; tracksBaseline=true; overhead=0.0 ms median/0.0 ms p95; audio=gameplay; renderer=695 calls/374861 tris/26 textures/pixelRatio=0.75; budget=pass; headroom=65 calls/45139 tris/8 tex.
...
- PASS render-budget/title: pass; profile=performance; calls=41/760; triangles=98809/420000; geometries=42/130; textures=7/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.21.0/fps/fps-title.png; headroom=719 calls, 321191 triangles, 88 geometries, 27 textures, 0 pixel ratio.
- PASS render-budget/gameplay: pass; profile=performance; calls=676/760; triangles=296698/420000; geometries=102/130; textures=21/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.21.0/fps/fps-gameplay.png; headroom=84 calls, 123302 triangles, 28 geometries, 13 textures, 0 pixel ratio.
- PASS render-budget/complete: pass; profile=performance; calls=674/760; triangles=208128/420000; geometries=101/130; textures=22/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.21.0/fps/fps-complete.png; headroom=86 calls, 211872 triangles, 29 geometries, 12 textures, 0 pixel ratio.
- PASS render-budget/caught: pass; profile=performance; calls=695/760; triangles=374861/420000; geometries=113/130; textures=26/34; pixelRatio=0.75/0.75; shadows=false/false; screenshot=docs/qa/2026-06-20/v0.21.0/fps/fps-caught.png; headroom=65 calls, 45139 triangles, 17 geometries, 8 textures, 0 pixel ratio.
...
- Matrix build=v0.21.0; generatedAt=2026-06-20T10:57:59.905Z; 2/2 mission browser playthroughs passed
- PASS playthrough/blacksite-threshold: status=pass; report=artifacts\playthrough\v0.21.0\playthrough-report.json; catalogKnown=true
- PASS playthrough/relay-vault: status=pass; report=artifacts\playthrough\v0.21.0\relay-vault\playthrough-report.json; catalogKnown=true
...
- PASS failure-route-screenshots: artifacts/failure-retry/v0.21.0/01-sentry-contact.png, artifacts/failure-retry/v0.21.0/02-retry-loading.png, artifacts/failure-retry/v0.21.0/03-retry-tutorial-reset.png

## Screenshot Coverage

- PASS screenshot/title.png: captured (558.0 KB)
- PASS screenshot/title-orbit-preview.png: captured (572.6 KB)
- PASS screenshot/settings.png: captured (457.0 KB)
- PASS screenshot/hero-select.png: captured (529.5 KB)
- PASS screenshot/loading-level-one.png: captured (437.0 KB)
