...
- Smoke screenshots: `artifacts/smoke/v0.12.3`
- Browser playthrough: `docs/qa/2026-06-20/v0.12.3/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.12.3/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.12.3/metrics.json`
- Screenshot coverage: 16/16 expected captures present (9945.1 KB)
- Metrics available: yes
- Game frame pacing: 56.2 FPS, 17.8 ms median, 17.7 ms latest, 18.3 ms p95, 240 samples
...
- PASS screenshot/loading-level-one.png: captured (525.2 KB)
