...
- Smoke screenshots: `artifacts/smoke/v0.13.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.13.0/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.13.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.13.0/metrics.json`
- Screenshot coverage: 16/16 expected captures present (9966.7 KB)
- Metrics available: yes
- Game frame pacing: 55.9 FPS, 17.9 ms median, 17.9 ms latest, 18.2 ms p95, 240 samples
...
- PASS screenshot/hero-select.png: captured (531.0 KB)
- PASS screenshot/loading-level-one.png: captured (525.1 KB)
...
- PASS screenshot/gameplay-command-codes.png: captured (654.4 KB)
