...
- Smoke screenshots: `artifacts/smoke/v0.12.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.12.1/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.12.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.12.1/metrics.json`
- Screenshot coverage: 16/16 expected captures present (9945.0 KB)
...
- PASS screenshot/title-orbit-preview.png: captured (569.0 KB)
- PASS screenshot/settings.png: captured (455.6 KB)
- PASS screenshot/hero-select.png: captured (532.1 KB)
- PASS screenshot/loading-level-one.png: captured (527.4 KB)
