...
- Smoke screenshots: `artifacts/smoke/v0.17.0`
- Browser playthrough: `docs/qa/2026-06-20/v0.17.0/playthrough-report.json` (captured)
- Failure/retry route: `docs/qa/2026-06-20/v0.17.0/failure-retry-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.17.0/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.17.0/metrics.json`
- Mission catalog evidence: `docs/qa/2026-06-20/v0.17.0/mission-catalog.json` (captured)
- Gameplay view density evidence: `docs/qa/2026-06-20/v0.17.0/gameplay-view-density.json` (captured)
- Screenshot coverage: 19/19 expected captures present (12711.5 KB)
...
- Game frame pacing: 56.5 FPS, 17.7 ms median, 17.7 ms latest, 18.2 ms p95, 240 samples
- Browser baseline: 55.9 FPS, 17.9 ms median, 18.1 ms p95, 240 samples
- FPS gate: environment-limited; profile=performance; strictTarget=false; browserCanProve60=false; tracksBaseline=true; overhead=-0.1 ms median/0.1 ms p95; headroom=-0.7 ms game/-0.8 ms browser
- FPS scene matrix: title=environment-limited (56.5 FPS, 17.7 ms median, 18.2 ms p95, overhead=-0.2 ms/0.1 ms); gameplay=environment-limited (56.5 FPS, 17.7 ms median, 18.2 ms p95, overhead=-0.2 ms/0.1 ms); complete=environment-limited (56.2 FPS, 17.8 ms median, 18.1 ms p95, overhead=-0.1 ms/0.0 ms); caught=environment-limited (56.2 FPS, 17.8 ms median, 18.1 ms p95, overhead=-0.1 ms/0.0 ms)
...
- Gameplay camera: readable=true; active=true; cameraDistance=6.23; screenHeight=29.0%; screenOccupancy=4.0%; screenBounds=x=620.01..819.99, y=376.02..633.56, viewport=1440x900, width=14.0%, height=29.0%, area=4.0%
- Gameplay view density: grade=pass; screenshot=gameplay-level-one.png; bands=near:pass:2 objects/2 categories/21.0%, mid:pass:4 objects/2 categories/94.0%, far:pass:5 objects/2 categories/61.0%
...
- ENVIRONMENT-LIMITED fps/title: label="Title hero and menu"; phase=title; screenshot=docs/qa/2026-06-20/v0.17.0/fps/fps-title.png; frame=56.5 FPS / 17.7 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=-0.2 ms median/0.1 ms p95; audio=title; renderer=41 calls/98809 tris/7 textures/pixelRatio=0.75. titleHero=facingDot=0.99; screenHeight=44.0%; occupancy=10.0%
- ENVIRONMENT-LIMITED fps/gameplay: label="Active gameplay camera"; phase=playing; screenshot=docs/qa/2026-06-20/v0.17.0/fps/fps-gameplay.png; frame=56.5 FPS / 17.7 ms median / 18.2 ms p95; strict=false; tracksBaseline=true; overhead=-0.2 ms median/0.1 ms p95; audio=gameplay; renderer=676 calls/296698 tris/21 textures/pixelRatio=0.75.
- ENVIRONMENT-LIMITED fps/complete: label="Mission complete screen"; phase=complete; screenshot=docs/qa/2026-06-20/v0.17.0/fps/fps-complete.png; frame=56.2 FPS / 17.8 ms median / 18.1 ms p95; strict=false; tracksBaseline=true; overhead=-0.1 ms median/0.0 ms p95; audio=complete; renderer=674 calls/208128 tris/22 textures/pixelRatio=0.75.
- ENVIRONMENT-LIMITED fps/caught: label="Sentry caught failure screen"; phase=caught; screenshot=docs/qa/2026-06-20/v0.17.0/fps/fps-caught.png; frame=56.2 FPS / 17.8 ms median / 18.1 ms p95; strict=false; tracksBaseline=true; overhead=-0.1 ms median/0.0 ms p95; audio=gameplay; renderer=695 calls/374861 tris/26 textures/pixelRatio=0.75.
...
- PASS gameplay-camera: active=true; readable=true; cameraDistance=6.23; target=(-24,1.15,-25); camera=(-20.85,3.85,-29.65); screenHeight=29.0%; screenOccupancy=4.0%; screenBounds=x=620.01..819.99, y=376.02..633.56, viewport=1440x900, width=14.0%, height=29.0%, area=4.0%. Gameplay camera keeps the player close enough to read the hero, nearby floor texture, cover, doors, and objectives.
...
- PASS failure-route-screenshots: artifacts/failure-retry/v0.17.0/01-sentry-contact.png, artifacts/failure-retry/v0.17.0/02-retry-loading.png, artifacts/failure-retry/v0.17.0/03-retry-tutorial-reset.png

## Screenshot Coverage

- PASS screenshot/title.png: captured (558.2 KB)
- PASS screenshot/title-orbit-preview.png: captured (572.6 KB)
- PASS screenshot/settings.png: captured (456.8 KB)
- PASS screenshot/hero-select.png: captured (529.1 KB)
- PASS screenshot/loading-level-one.png: captured (522.7 KB)
- PASS screenshot/tutorial-01-insertion.png: captured (782.8 KB)
- PASS screenshot/tutorial-02-keycard.png: captured (685.2 KB)
- PASS screenshot/tutorial-03-terminal.png: captured (794.5 KB)
- PASS screenshot/tutorial-04-sentry.png: captured (808.7 KB)
- PASS screenshot/tutorial-05-extraction.png: captured (722.0 KB)
- PASS screenshot/gameplay-level-one.png: captured (660.9 KB)
- PASS screenshot/focus-lobby-door.png: captured (765.7 KB)
- PASS screenshot/focus-server-door.png: captured (692.4 KB)
- PASS screenshot/gameplay-command-codes.png: captured (623.9 KB)
- PASS screenshot/focus-extraction-door.png: captured (760.2 KB)
- PASS screenshot/complete.png: captured (588.1 KB)
- PASS screenshot/caught-sentry.png: captured (620.4 KB)
- PASS screenshot/retry-loading.png: captured (783.6 KB)
- PASS screenshot/retry-tutorial-reset.png: captured (783.7 KB)
...
- Performance: 4 scene samples match the 55.9 FPS browser baseline with -0.1 ms median / 0.1 ms p95 overhead, but this environment cannot prove strict 16.7 ms frame cadence.

## Required Fixes

- P0: None recorded by generated report.
- P1: Current headed browser baseline measured 55.9 FPS / 17.9 ms median and cannot prove strict 16.7 ms on the performance profile. The game tracks that baseline within the calibrated overhead budget across 4 scene sample(s): title=environment-limited, gameplay=environment-limited, complete=environment-limited, caught=environment-limited (-0.1 ms median / 0.1 ms p95), so rerun on a true 60 Hz visible browser before marking the 60 FPS gate fully proven.
