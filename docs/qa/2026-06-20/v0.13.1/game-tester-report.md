...
- Smoke screenshots: `artifacts/smoke/v0.13.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.13.1/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.13.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.13.1/metrics.json`
- Screenshot coverage: 16/16 expected captures present (9970.0 KB)
- Metrics available: yes
- Game frame pacing: 56.2 FPS, 17.8 ms median, 17.7 ms latest, 18.2 ms p95, 240 samples
...
- PASS screenshot/title-orbit-preview.png: captured (569.2 KB)
- PASS screenshot/settings.png: captured (457.9 KB)
- PASS screenshot/hero-select.png: captured (531.7 KB)
- PASS screenshot/loading-level-one.png: captured (525.5 KB)
- PASS screenshot/tutorial-01-insertion.png: captured (705.6 KB)
- PASS screenshot/tutorial-02-keycard.png: captured (617.2 KB)
- PASS screenshot/tutorial-03-terminal.png: captured (725.1 KB)
- PASS screenshot/tutorial-04-sentry.png: captured (690.4 KB)
- PASS screenshot/tutorial-05-extraction.png: captured (680.1 KB)
- PASS screenshot/gameplay-level-one.png: captured (657.8 KB)
- PASS screenshot/focus-lobby-door.png: captured (694.9 KB)
- PASS screenshot/focus-server-door.png: captured (668.2 KB)
