...
- Smoke screenshots: `artifacts/smoke/v0.9.1`
- Browser playthrough: `docs/qa/2026-06-20/v0.9.1/playthrough-report.json` (captured)
- Committed screenshots: `docs/qa/2026-06-20/v0.9.1/screenshots`
- FPS metrics: `docs/qa/2026-06-20/v0.9.1/metrics.json`
- Screenshot coverage: 14/14 expected captures present (9000.8 KB)
...
- Title composition: heroReadable=true; facingDot=0.99; cameraDistance=7.62; heroYaw=0.55; yawToCamera=0.69
...
- PASS screenshot/title.png: captured (624.5 KB)
- PASS screenshot/settings.png: captured (492.5 KB)
- PASS screenshot/hero-select.png: captured (576.8 KB)
...
- PASS screenshot/gameplay-level-one.png: captured (657.9 KB)
