...
- Use `$threejs-level-geometry-validator` for level creator loops, blockout math, bounds containment, door openings, wall overlap checks, clearance rules, collision proxy sanity, and navmesh blocker preparation.
