...
- Treat visible blockers as level art, not just collision. Replace blockout rectangles with fitted GLB/generated cover kits once routes are proven, and keep the authored blocker proxy as the collision truth so geometry tests remain stable.
